...
-   ### Testing User Stories from User Experience Section
    ...
    -   #### CHECKOUT, PAYMENT AND ORDERS
        ...
        | 3 | As a First Time, Returning or Frequent Visitor | I would like to view my past orders in my profile | So that I can check back over an old order in case we need to return an item. | Tested outcome here Tested outcome here | &#9744; |
        | 4 | As a First Time, Returning or Frequent Visitor | I would like to cancel the checkout process and not proceed to payment | So that I can easily exit out of the payment process should we change our mind | Tested outcome here Tested outcome here | &#9744; |
