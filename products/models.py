...
class Product(models.Model):
    ...
    fork = models.CharField(max_length=254, null=True, blank=True)
    groupset = models.CharField(max_length=254, null=True, blank=True)
    wheels = models.CharField(max_length=254, null=True, blank=True)
